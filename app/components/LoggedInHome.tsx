...
// Legacy devnet/old mints → canonical mainnet mints for xStocks
const MINT_ALIAS_TO_CANONICAL: Record<string, string> = {
  Xsc9qvGR1efVDFGLrVsmkzv3qi45LTBjeUKSPmx9qEh:
    "9gwTegFJJErDpWJKjPfLr2g2zrE3nL1v5zpwbtsk3c6P", // NVDAx
  XsbEhLAtcf6HdfpFZ5xEMdqW8nfAvcsP5bdudRLJzJp:
    "HLm32fkK51wSi8TM9DvFmPuKjNbKzPkCTrXPnygsMVUp", // AAPLx
  Xs3eBt7uRfJX8QUs4suhyU8p2M6DoUDrJyWBa8LLZsg:
    "7VDEsKBXWSjVVaVzqz5vfuU2G5xCXvVRjTHqP9Kjqwn1", // AMZNx
  XsDoVfqeBukxuZHWhdvWHBhgEHjGNst4MLodqsJHzoB:
    "3n3LPMZ4PTLpKqTxkHfrAtqdqFKUxzGbrBhi7qKHnipG", // TSLAx
  XsCPL9dNWBMvFtTmwcCA5v3xWPSMEBCszbQdiLLq6aN:
    "67So6HhEkba1cPTJ2KUQGCE2t5M9YnJLCBq4gQ1NyLAn", // GOOGLx
  Xsa62P5mvPszXL1krVUnU5ar38bBSVcWAB6fmPCo5Zu:
    "METADDFL6wWMWEoKTFJwcThTbUmtarRJZjRpzUvkxhr", // METAx
  XspzcW1PRtgf6Wj92HCiZdjzKCyFekVD8P5Ueh3dRMX:
    "ANNmJmGxHwUsVRnqfLfbcH3eH1f1YuBDGoMbgeAt9zLP", // MSFTx
};
...
export default function LoggedInHome({ demo = false }: { demo?: boolean }) {
  ...
  const holdings = useMemo(() => {
    ...
    const rows = Object.entries(balances)
      ...
      .map(([mint, bal]) => {
        const canonicalMint = MINT_ALIAS_TO_CANONICAL[mint] ?? mint;
        const asset = getAssetByMint(canonicalMint);
        ...
        const live = safeNumber(
          pricesUsdByMint?.[canonicalMint] ?? pricesUsdByMint?.[mint],
          0
        );
